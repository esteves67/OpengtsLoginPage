      ...
      //final boolean legacy = this.getProperties().getBoolean(PROP_legacyLAF,false);
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(cssAccountLogin, pageMsg) {
            public void write(PrintWriter out) throws IOException {
                ...
                out.println("<div class='header-login' >");
                ...
                if (acctLogin) {
                    ...
                    out.print("");
                    out.print("<input id='"+fldID+"' class='form-control' placeholder='Account'  type='text' "+ro+" name='"+Constants.PARM_ACCOUNT+"' value='"+accountID+"' size='24' maxlength='32'>");
                    out.print("<br />");
                    focusFieldID = fldID;
                }
                // user login field
                ...
                if (userLogin) {
                    String fldID = "userLoginField";
                    out.print("");
                    out.print("<input id='"+fldID+"' class='form-control' placeholder='User'  type='text' "+ro+" name='"+Constants.PARM_USER+"' value='"+userID+"' size='24' maxlength='32'>");
                    out.print("<br />");
                    if (StringTools.isBlank(focusFieldID)) { focusFieldID = fldID; }
                } else
                if (emailLogin) {
                ...
                if (showPasswd) {
                    out.print("");
                    out.print("");
                    out.print("<input class='form-control' placeholder='Password'  type='password' "+ro+" name='"+Constants.PARM_PASSWORD+"' value='' size='24' maxlength='32'>");
                    out.print("<br />");
                }
                // language selection
                if (showLocale) {
                ...
                // Login
                out.print("");
                out.print("<input style='width:100%; background:#1ABC9C; color:#fff;' class='btn btn-default' type='submit' value='"+i18n.getString("AccountLogin.login","Login")+"' >");
                // forgot password
